...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Any
    {
        ...
        {
            var doAny = PracticeData.Any(c => c.PrimaryInstructor.Birthday.Year < 1990 && c.PrimaryInstructor.Birthday.Year > 1979);
        ...
        {
            var doAny = PracticeData[2].Students.Any(c => c.Active == false && c.Birthday.Month == 10);  //HINT: Cohort3 is PracticeData[2]
