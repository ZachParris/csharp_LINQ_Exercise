...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(c => (c.JuniorInstructors.Any(n => n.FirstName =="Kate") || c.PrimaryInstructor.FirstName == "Kate") || c.Students.Any(s => s.FirstName == "Kate")).ToList();
        ...
        {
            var student = PracticeData.SelectMany(c => c.Students).OrderBy(a => a.Birthday).First();
        ...
        {
            var student = PracticeData.SelectMany(c => c.Students).OrderBy(a => a.Birthday).Last();
